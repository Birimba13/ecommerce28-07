...
<head>
    ...
    <title>Boticário Jerosch - Perfumaria & Cosméticos</title>
...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="mb-0 text-muted">
                        © 2025 Todos os direitos reservados | Desenvolvido por João Jerosch
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        window.onload = function () {
            console.log('Boticário Jerosch - Sistema iniciado com sucesso!');
            verificarItensCarrinho();
            setTimeout(() => {
                mostrarNotificacao('Bem-vindo ao Boticário Jerosch! Use os filtros para encontrar seus produtos favoritos!', 'success');
            }, 1000);
        };
    </script>
</body>
